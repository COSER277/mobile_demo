;(function () {
    ...
    define("cordova", function (require, exports, module) {
        ...
        var cordova = {
            ...
            addWindowEventHandler: function (event) { return (windowEventHandlers[event] = channel.create(event)) }, 
            addStickyDocumentEventHandler: function (event) { return (documentEventHandlers[event] = channel.createSticky(event)) }, 
            addDocumentEventHandler: function (event) { return (documentEventHandlers[event] = channel.create(event)) }, 
            removeWindowEventHandler: function (event) { delete windowEventHandlers[event] }, 
            removeDocumentEventHandler: function (event) { delete documentEventHandlers[event] }, 
            getOriginalHandlers: function () { 
                return { 
                    "document": { "addEventListener": m_document_addEventListener, 
        ...
        fireDocumentEvent: function (type, data, bNoDetach) {
                ...
                if (typeof documentEventHandlers[type] != "undefined") {
                    if (bNoDetach) { 
                        ...
                        setTimeout(function () {
                            if (type == "deviceready") { document.dispatchEvent(evt) } documentEventHandlers[type].fire(evt)
                        }, 0)
                    }
    ...
    define("cordova/argscheck", function (require, exports, module) {
        ...
        function checkArgs(spec, functionName, args, opt_callee) {
            ...
            if (errMsg) { 
                ...
                if (typeof jasmine == "undefined") { console.error(errMsg) } 
    ...
    define("cordova/builder", function (require, exports, module) {
        ...
        function clobber(obj, key, value) { 
            ...
            try { obj[key] = value } catch (e) { needsProperty = true } 
    ...
    define("cordova/channel", function (require, exports, module) {
        ...
        Channel.prototype.subscribe = function (eventListenerOrFunction, eventListener) { 
            ...
            if (typeof eventListener === "object") { handleEvent = utils.close(eventListener, handleEvent) } 
    ...
    define("cordova/exec", function (require, exports, module) {
        ...
        function massageArgsJsToNative(args) { 
            if (!args || utils.typeName(args) != "Array") { return args } 
            var ret = []; 
        ...
        function iOSExec() { 
            ...
            if (typeof arguments[0] !== "string") { 
                ...
                throw new Error("The old format of this exec call has been removed (deprecated since 2.1). Change to: " + "cordova.exec(null, null, 'Service', 'action', [ arg1, arg2 ]);") 
            } 
            actionArgs = actionArgs || []; 
            if (successCallback || failCallback) { 
                callbackId = service + cordova.callbackId++; cordova.callbacks[callbackId] = { success: successCallback, fail: failCallback } 
            } 
            actionArgs = massageArgsJsToNative(actionArgs); 
            var command = [callbackId, service, action, actionArgs]; 
            commandQueue.push(JSON.stringify(command)); 
            if (!isInContextOfEvalJs && commandQueue.length == 1) { pokeNative() } 
        } 
            
        function proxyChanged() { 
            var cexec = cordovaExec(); 
            return (execProxy !== cexec && iOSExec !== cexec) 
        } 
    ...
    define("cordova/init", function (require, exports, module) {
        ...
        if (document.readyState == "complete" || document.readyState == "interactive") { 
            ...
            channel.join(function () {
                ...
                channel.join(function () { require("cordova").fireDocumentEvent("deviceready") 
    ...
    define("cordova/modulemapper", function (require, exports, module) {
        ...
        function addEntry(strategy, moduleName, symbolPath, opt_deprecationMessage) { 
            ...
            if (opt_deprecationMessage) { deprecationMap[symbolPath] = opt_deprecationMessage } 
        } 
        ...
        function prepareNamespace(symbolPath, context) { 
            ...
            var cur = context; 
            for (var i = 0, part; part = parts[i]; ++i) { cur = cur[part] = cur[part] || {} } return cur 
        }
    ...
    define("cordova/modulemapper_b", function (require, exports, module) {
        ...
        exports.mapModules = function (context) {
            ...
            for (var i = 0, len = symbolList.length; i < len; i += 3) { 
                ...
                var parentObj = prepareNamespace(namespace, context); 
                var target = parentObj[lastName]; 
                if (strategy == "m" && target) { builder.recursiveMerge(target, module) } 
                else { 
                    if ((strategy == "d" && !target) || (strategy != "d")) { 
                        if (!(symbolPath in origSymbols)) { 
                            origSymbols[symbolPath] = target 
    ...
    define("cordova/pluginloader", function (require, exports, module) {
        ...
        exports.load = function (callback) { 
            ...
            function () { var moduleList = require("cordova/plugin_list"); 
    ...
    define("cordova/utils", function (require, exports, module) {
        ...
        utils.arrayRemove = function (a, item) { 
            ...
            utils.isArray = Array.isArray || function (a) { return utils.typeName(a) == "Array" }; 
            utils.isDate = function (d) { return (d instanceof Date) }; 
            utils.clone = function (obj) { 
                ...
                if (utils.isArray(obj)) { 
                    retVal = []; 
                    for (i = 0; i < obj.length; ++i) { retVal.push(utils.clone(obj[i])) } 
                    return retVal 
                } 
